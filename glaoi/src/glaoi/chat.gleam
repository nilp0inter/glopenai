...
pub fn parse_stream_chunk(
  data: String,
) -> Result(Option(CreateChatCompletionStreamResponse), GlaoiError) {
  case data {
    "[DONE]" -> Ok(None)
    _ ->
      case
...
) -> Result(CreateChatCompletionResponse, GlaoiError) {
...
pub fn list_response(
  response: Response(String),
) -> Result(ChatCompletionList, GlaoiError) {
...
pub fn delete_response(
  response: Response(String),
) -> Result(ChatCompletionDeleted, GlaoiError) {
