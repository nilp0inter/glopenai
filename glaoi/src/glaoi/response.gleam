...
pub fn parse_stream_event(
  data: String,
) -> Result(Option(ResponseStreamEvent), GlaoiError) {
  case data {
    "[DONE]" -> Ok(None)
    _ ->
...
pub fn delete_response(
  response: HttpResponse(String),
) -> Result(DeleteResponse, GlaoiError) {
...
pub fn list_input_items_response(
  response: HttpResponse(String),
) -> Result(ResponseItemList, GlaoiError) {
...
pub fn get_input_token_counts_response(
  response: HttpResponse(String),
) -> Result(TokenCountsResource, GlaoiError) {
...
pub fn compact_response(
  response: HttpResponse(String),
) -> Result(CompactResource, GlaoiError) {
