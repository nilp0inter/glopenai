...
) -> Result(VectorStoreObject, GlaoiError) {
...
pub fn list_response(
  response: Response(String),
) -> Result(ListVectorStoresResponse, GlaoiError) {
...
pub fn delete_response(
  response: Response(String),
) -> Result(DeleteVectorStoreResponse, GlaoiError) {
...
pub fn search_response(
  response: Response(String),
) -> Result(VectorStoreSearchResultsPage, GlaoiError) {
...
pub fn file_create_response(
  response: Response(String),
) -> Result(VectorStoreFileObject, GlaoiError) {
...
pub fn file_delete_response(
  response: Response(String),
) -> Result(DeleteVectorStoreFileResponse, GlaoiError) {
...
pub fn file_list_response(
  response: Response(String),
) -> Result(ListVectorStoreFilesResponse, GlaoiError) {
...
pub fn file_content_response(
  response: Response(String),
) -> Result(VectorStoreFileContentResponse, GlaoiError) {
  internal.parse_response(
    response,
...
pub fn batch_create_response(
  response: Response(String),
) -> Result(VectorStoreFileBatchObject, GlaoiError) {
