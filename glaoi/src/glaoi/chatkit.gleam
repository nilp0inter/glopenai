...
) -> Result(ChatSessionResource, GlaoiError) {
...
pub fn thread_list_response(
  response: Response(String),
) -> Result(ThreadListResource, GlaoiError) {
...
pub fn thread_retrieve_response(
  response: Response(String),
) -> Result(ThreadResource, GlaoiError) {
...
pub fn thread_delete_response(
  response: Response(String),
) -> Result(DeletedThreadResource, GlaoiError) {
...
pub fn thread_items_list_response(
  response: Response(String),
) -> Result(ThreadItemListResource, GlaoiError) {
