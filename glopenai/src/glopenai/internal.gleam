...
import gleam/uri
import glopenai/config.{type AzureConfig, type Config}
import glopenai/error.{
  type GlopenaiError, ApiResponseError, JsonDecodeError, UnexpectedResponse,
}
...
/// or returning a GlopenaiError on failure.
pub fn parse_response(
  response: Response(String),
  decoder: decode.Decoder(a),
) -> Result(a, GlopenaiError) {
