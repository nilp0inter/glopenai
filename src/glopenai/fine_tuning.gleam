...
import glopenai/shared.{type ReasoningEffort}
...
) -> Result(FineTuningJob, GlopenaiError) {
...
pub fn list_response(
  response: Response(String),
) -> Result(ListPaginatedFineTuningJobsResponse, GlopenaiError) {
...
pub fn list_events_response(
  response: Response(String),
) -> Result(ListFineTuningJobEventsResponse, GlopenaiError) {
  internal.parse_response(
    response,
...
pub fn list_checkpoints_response(
  response: Response(String),
) -> Result(ListFineTuningJobCheckpointsResponse, GlopenaiError) {
  internal.parse_response(
    response,
...
pub fn create_checkpoint_permission_response(
  response: Response(String),
) -> Result(ListFineTuningCheckpointPermissionResponse, GlopenaiError) {
  internal.parse_response(
    response,
...
pub fn delete_checkpoint_permission_response(
  response: Response(String),
) -> Result(DeleteFineTuningCheckpointPermissionResponse, GlopenaiError) {
  internal.parse_response(
    response,
